...
//     if (outFile.is_open())
//     {
//         outFile << "Engr. Muhammad Moh$in" << endl; // Write to file
...
// Question How to append more data in file withour removing the previous one via library fstream  and functions ofstream
#include <iostream>
#include <fstream>
